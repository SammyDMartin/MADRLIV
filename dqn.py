...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed,alpha,gamma,batch_size,tau,UI,buffer_size):
        ...
        self.seed = torch.random.seed(seed)
        self.gamma = gamma
        self.tau = tau
        self.UI = UI
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        self.t_step = (self.t_step + 1) % self.UI
        if self.t_step == 0:
